  ...
  return (
    <Wrapper className="px-5 py-10">
      <div className="mx-auto max-w-screen-md">
        ...
        <img src="/static/images/nstar/nstar_atomic_done.svg" className="mx-auto h-40 max-w-sm" alt="Done" />
        ...
        <div className="mt-10 w-full space-y-5 text-center">
          ...
          <div className="font-heading text-2xl">{t('QUEST_RESULT.DONE_SUBTITLE', { ns: 'activity' })}</div>
        </div>
